...
throws_ok { $jb->play_music( 'mp3', 'RomanceMe' ) } qr/Unknown directory/,
    'play_music() shoud throw exception if it cannot find directory';
...
is( $args->[1], 'my_directory',     '... saving to the property directory'  );
