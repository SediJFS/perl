...
{
    package SongPlayer;
    # versteckt die Systemfunktion 'system' und verweist statt dessen auf die in 
    # diesem Packet enthaltene Funktion.
    use subs 'system';
    
    package main;
    # Im package main wir die Systemfunktion 'system' mit einer neuen Funktion 
    # überschrieben. 
    my $fail = 0;
    my @args;
    ...
    *SongPlayer::system = sub
    ...
    lives_ok { $song->play() } 'play() should life if launching succeeds';
